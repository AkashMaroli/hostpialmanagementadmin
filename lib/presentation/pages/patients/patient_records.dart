...
import 'package:hospitalmanagementadmin/presentation/widgets/patients_detail_page.dart';
      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text(
              'Check your Last 7 days Patients List',
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Center(child: Text(patient.age.toString()))),
                Expanded(child: Center(child: Text(patient.gender))),
                Expanded(
                  flex: 2,
                  child: Center(
                    child: Text(
                ...
                Expanded(
                  flex: 2,
                  child: Center(child: Text(patient.department)),
                ),
                Expanded(
                  child: Center(child: Text(_formatDate(patient.dateInfo))),
                ),
                Expanded(
                  child: Center(
